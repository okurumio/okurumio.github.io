...
pip3 install redis pymysql requests httpx pyexecjs pymongo kafka-python lxml flask DBUtils apscheduler -i https://pypi.tuna.tsinghua.edu.cn/simple --no-cache-dir
```
**保存为新镜像**
```bash
