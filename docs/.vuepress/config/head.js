...
module.exports = [
  ...
  ['link', { rel: 'stylesheet', href: '//at.alicdn.com/t/font_3114978_qe0b39no76.css' }], //阿里矢量图库地址：https://www.iconfont.cn/

  ['meta',{name: 'keywords',content: 'chara',},],
  // ['meta', { name: 'baidu-site-verification', content: 'code-LTKHwOecxI' }], // 百度统计的站长验证
  ['meta', { name: 'theme-color', content: '#6aadbb' }], // 移动浏览器主题颜色
  // [
  //   'script',
  //   {
